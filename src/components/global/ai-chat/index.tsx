...
export const AIChat = ({ lectureContent }: AIChatProps) => {
    ...
    return (
        <div className="p-5 bg-gray-900 border border-gray-700 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold mb-4 text-gray-100">GrowthHungry AI</h3>
            <textarea
            ...
            />
            <Button onClick={handleAskQuestion} disabled={loading} className="mt-4">
                ...
                <div className="mt-5 p-4 bg-gray-800 border border-gray-600 rounded-lg">
                    ...
                    <ReactMarkdown
                        ...
                        components={{
                            ...
                            h1({ children }) {
                                return <h1 className="text-2xl font-bold mt-4">{children}</h1>;
                            },
                            h2({ children }) {
                                return <h2 className="text-xl font-semibold mt-3">{children}</h2>;
                            },
                            h3({ children }) {
                                return <h3 className="text-lg font-semibold mt-2">{children}</h3>;
                            },
                        }}
                    >
                        {answer}
