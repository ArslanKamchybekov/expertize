...
import { AlertTriangle, Calendar, CheckCircle2, CreditCard, Group } from "lucide-react"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentSubscriptions.length > 0 ? (
              currentSubscriptions.map((subscription) => {
                const group = groups.find((g) => g.id === subscription.groupId);
                const subscriptionDate = new Date(subscription.createdAt);
                const isRecentSubscription = Date.now() - subscription.createdAt < 7 * 24 * 60 * 60 * 1000; // 7 days
                  ...
                  >
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span>Started {subscriptionDate.toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'long',
                          day: 'numeric'
                        })}</span>
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span>Next billing date: {new Date(subscriptionDate.setMonth(
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              Are you sure you want to cancel your subscription to {group?.name}? 
                ...
                <div className="flex flex-col items-center justify-center gap-4">
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      You do not have any active subscriptions at the moment.
                    </p>
                  </div>
