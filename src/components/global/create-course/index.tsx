...
const CourseCreate = ({ groupid }: Props) => {
  ...
  if (data?.groupOwner) {
    return (
      ...
      >
        <form onSubmit={onCreateCourse} className="flex flex-col gap-y-5 mt-5 max-h-[80vh] overflow-y-auto p-2">
          <FormGenerator
            register={register}
            errors={errors}
            name="name"
          ...
          <div className="grid gap-2 grid-cols-3">
            ...
            <Label htmlFor="r2">
              <span>
                ...
                <Card
                  className={cn(
                    onPrivacy === "level-unlock" ? "bg-themeBlack" : "bg-transparent",
                    "py-5 flex justify-center border-themeGray font-bold text-themeTextGray cursor-pointer",
                  )}
                >
                  Level Unlock
            ...
            <Label htmlFor="r3">
              <span>
                ...
                <Card
                  className={cn(
                    onPrivacy === "private" ? "bg-themeBlack" : "bg-transparent",
                    "py-5 flex justify-center border-themeGray font-bold text-themeTextGray cursor-pointer",
                  )}
                >
                  Private
